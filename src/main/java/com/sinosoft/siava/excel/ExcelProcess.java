package com.sinosoft.siava.excel;
...
public class ExcelProcess {
     ...
     */
    public ExcelProcess(String excelFilePath) throws IOException, InvalidFormatException {
        this.startRow = 0;
     ...
     * @throws IOException IO流异常
     */
    public ExcelProcess(InputStream inputStream) throws IOException, InvalidFormatException {
        this.startRow = 0;
        this.sheetName = "Sheet1";
        this.excelFilePath = "";
     ...
     * @throws IOException            IO流异常
     */
    public ExcelProcess(InputStream inputStream, String outFilePath) throws IOException, InvalidFormatException {
        this.startRow = 0;
        this.sheetName = "Sheet1";
